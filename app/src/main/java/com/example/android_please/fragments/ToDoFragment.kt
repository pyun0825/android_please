...
class ToDoFragment(context: Context, var adapter: todoGridAdapter) : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        val et_date = RootView.findViewById<EditText>(R.id.et_link)
        val et_todo = RootView.findViewById<EditText>(R.id.et_todo)
        val btn_cancel = RootView.findViewById<Button>(R.id.bt_link_cancel)
        val btn_submit = RootView.findViewById<Button>(R.id.bt_link_submit)
